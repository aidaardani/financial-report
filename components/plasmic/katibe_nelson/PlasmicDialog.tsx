...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: 1uYO8IBI-yA_/css
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({
        [sty["pcls_O2OGHQ9hkXdH"]]: hasVariant(
          globalVariants,
          "screen",
          "mobileOnly"
        ),
        [sty["pcls_fwmKfbRoqugK"]]: true
      })}
          ...
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  ...
                  endIcon={
                    <ChevronLeftIcon
                      className={classNames(projectcss.all, sty.svg__veR4P)}
                      role={"img"}
                    />
                  }
                  startIcon={
                    <ChevronRightIcon
                      className={classNames(projectcss.all, sty.svg__ccCf7)}
                      role={"img"}
                    />
                  }
                />
    ...
    >
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__yxPnG)}
          dir={"rtl"}
        >
          <DialogTitle
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___9RhoU)}
          dir={"rtl"}
        >
          {renderPlasmicSlot({
            defaultContents: (
