...
import sty from "./PlasmicDialog2.module.css"; // plasmic-import: pBmLvvMadM84/css
...
function PlasmicDialog2__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_hMBS4RPVbUxU"]]: true })}
          ...
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  ...
                  endIcon={
                    <Icon23Icon
                      className={classNames(projectcss.all, sty.svg___1GqBu)}
                      role={"img"}
                    />
                  }
                  startIcon={
                    <Icon22Icon
                      className={classNames(projectcss.all, sty.svg__ry6Tw)}
                      role={"img"}
                    />
                  }
                />
    ...
    >
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ez3Wz)}
          dir={"rtl"}
        >
          <DialogTitle
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___5BF7B)}
          dir={"rtl"}
        >
          {renderPlasmicSlot({
            defaultContents: (
