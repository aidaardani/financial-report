...
import sty from "./PlasmicRegisterBankAccount.module.css"; // plasmic-import: KJ0W_ojWp9oQ/css
...
function PlasmicRegisterBankAccount__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__qtCA)}>
        <div className={classNames(projectcss.all, sty.freeBox__jVgco)}>
          <TextInput
        ...
        <div className={classNames(projectcss.all, sty.freeBox__usuGh)}>
          <div className={classNames(projectcss.all, sty.freeBox___6TxmC)}>
            <Button
              ...
              endIcon={
                <ChevronLeftIcon
                  className={classNames(projectcss.all, sty.svg__ofgj)}
                  role={"img"}
                />
              }
              isDisabled={(() => {
              ...
              startIcon={
                <ChevronRightIcon
                  className={classNames(projectcss.all, sty.svg__vetZa)}
                  role={"img"}
                />
              }
            />
            ...
            {(() => {
              ...
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg___9WOyF)}
                role={"img"}
              />
            ) : null}
          </div>
