...
import Label from "../../Label"; // plasmic-import: YyoV-0axFWdk/component
import Radio from "../../Radio"; // plasmic-import: JZAk1ag0Q0kl/component
import Description from "../../Description"; // plasmic-import: Ic2pB7e5lUDQ/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: lDXIjDSK4JMA/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__ao3K)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__i5Hwb)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__gg9Gy)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__mf2BO)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
