...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: Ev4iW7Mtn_vF/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: 1PveLuDTgrg7/icon
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__iZ8X3)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__ddrln)}
                role={"img"}
              />
            ),
