...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Ij0ry6JbrjCi/css

import ChevronRightIcon from "../fragment_icons/icons/PlasmicIcon__ChevronRight"; // plasmic-import: GHdF3hS-oP_3/icon
import Icon21Icon from "./icons/PlasmicIcon__Icon21"; // plasmic-import: vUeD1K_7QP50/icon
    ...
    <button
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_text_size_compact_showStartIcon]:
            hasVariant($state, "color", "text") &&
            hasVariant($state, "size", "compact") &&
      ...
      {(
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__tAkZa)}
                role={"img"}
              />
            ),
        ...
        >
          <Icon21Icon
            ...
            className={classNames(projectcss.all, sty.svg, "loader", {
              ...
              [sty.svgoutline_color_link_loading]:
                hasVariant($state, "loading", "loading") &&
                hasVariant($state, "outline", "outline") &&
                hasVariant($state, "color", "link"),
          ...
          {(hasVariant($state, "loading", "loading") ? false : true)
            ? renderPlasmicSlot({
                ...
                className: classNames(sty.slotTargetChildren2, {
                  ...
                  [sty.slotTargetChildren2outline_color_sand]:
                    hasVariant($state, "color", "sand") &&
                    hasVariant($state, "outline", "outline"),
      ...
      {(
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronLeftIcon
                className={classNames(projectcss.all, sty.svg___5J2Hr)}
                role={"img"}
              />
            ),
