...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: JZAk1ag0Q0kl/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__rpCmA)}>
        <div className={classNames(projectcss.all, sty.freeBox__s5WGs)} />
      </div>
      {renderPlasmicSlot({
