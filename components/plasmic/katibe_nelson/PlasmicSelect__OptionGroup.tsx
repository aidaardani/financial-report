...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: b88ToCuPepNj/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: myk0CMMqTo5_/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__bpEjI)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__v5Rnd)}
              />
            </React.Fragment>
          ),
          value: args.children
